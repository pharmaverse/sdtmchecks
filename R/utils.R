...
#' @title Diff two sdtmchecks reports
#' @description run_all_checks will generate a list of check results.  This function
...
#'
#' @param old_report older sdtmchecks report as generated by run_all_checks
#' @param new_report newer sdtmchecks report as generated by run_all_checks
#'
#' @return list of diffed sdtmchecks results
