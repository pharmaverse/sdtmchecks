...
#' 
#' @description This report will identify flagged records from sdtmcheck functions
...
#' as an issue in SDTM).
#'
#' @param old_report older sdtmchecks report as generated by sdtmchecks::run_all_checks()
#' @param new_report newer sdtmchecks report as generated by sdtmchecks::run_all_checks()
#'
