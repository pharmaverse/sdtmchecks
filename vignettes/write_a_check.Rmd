...
The `main` branch of the [repo](https://github.com/pharmaverse/sdtmchecks) contains the latest released version and should not be used for development.

The `devel` branch is the default branch and contains the latest development version of the package. To start contributing, please make a feature branch off of `devel`. If there is an associated [GitHub Issue](https://github.com/pharmaverse/sdtmchecks/issues) that you are addressing, using the issue number as the prefix of the feature branch name can help align the issue being addressed and the code being developed. For example, issue [#62](https://github.com/pharmaverse/sdtmchecks/issues/62) was addressed by a branch named `62_chkdsdthmult`. 

When your code is ready to be incorporated please open a pull request that another person will review prior to merging the update into `devel`. If you do not have write access to the repository, please work off of a forked repo and [open a pull request from the fork]( 
